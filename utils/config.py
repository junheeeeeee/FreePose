...
def get_parse_args():
    ...
    # Evaluate choice
    parser.add_argument('--h36m', default=True, type=bool, metavar='NAME', help='h36m dataset')
    parser.add_argument('--h36mp', default=True, type=bool, metavar='NAME', help='h36mp dataset')
    parser.add_argument('--3dhp', default=True, type=bool, metavar='NAME', help='3dhp dataset')
    parser.add_argument('--3dpw', default=True, type=bool, metavar='NAME', help='3dpw dataset')
    ...
    parser.add_argument('--frame_size', default=3, type=int, metavar='N', help='number of frame')
    # Learning rate
